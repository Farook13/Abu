...
PICS = (environ.get('PICS', 'https://envs.sh/icU.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/e20b5fdaf217252964202.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://envs.sh/icP.MP4")
...
MAX_B_TN = environ.get("MAX_B_TN", "3")
...
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : Batman group') #Log channel id ( make sure bot is admin )
